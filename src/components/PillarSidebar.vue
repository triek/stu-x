...
const resolvedSortFilters = computed(() =>
  props.sortFilters.length
    ? props.sortFilters
    : ['Latest', 'Most Popular', 'Reward Points'],
)
            ...
            <button
              ...
              :class="[
                category.isActive
                  ...
                  : 'border-indigo-100/70 text-slate-600 hover:border-indigo-200 hover:text-brand'
              ]"
