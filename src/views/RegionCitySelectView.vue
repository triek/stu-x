...
<template>
  ...
  >
    ...
    <div class="grid gap-4 sm:grid-cols-2">
      ...
      >
        <span
          ...
          :class="
            city.accent ?? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-200'
          "
        >
        ...
        <span
          ...
          :class="{ 'text-slate-400 dark:text-slate-500': city.isActive === false }"
        >
    ...
    <p v-if="!cities.length" class="text-sm text-slate-500 dark:text-slate-300">
      We’re still onboarding cities for this region. Check back soon or request your city on the
      landing page.
    </p>
  </section>
</template>
