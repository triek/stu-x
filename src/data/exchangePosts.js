export const exchangePosts = [
  ...
  },
  {
    ...
    actions: [
      { icon: '📅', label: 'Session Times' },
      { icon: '✍️', label: 'Join Jam', highlight: true },
    ],
    status: 'active',
  },
  {
    ...
    actions: [
      { icon: '📋', label: 'Topic List' },
      { icon: '🧫', label: 'Join Review', highlight: true },
    ],
    status: 'active',
  },
  ...
  },
  {
    ...
    actions: [
      { icon: '🎓', label: 'View Curriculum' },
      { icon: '🚀', label: 'Enroll Now', highlight: true },
    ],
    status: 'active',
  },
  {
    ...
    actions: [
      { icon: '📝', label: 'Course Outline' },
      { icon: '💡', label: 'Join Class', highlight: true },
    ],
    status: 'active',
  },
  ...
  },
  {
    ...
    actions: [
      { icon: '👀', label: 'Preview File' },
      { icon: '💾', label: 'Download PDF', highlight: true },
    ],
    status: 'available',
  },
  {
  ...
  },
  {
    ...
    actions: [
      ...
      { icon: '🧠', label: 'Join Discussion', highlight: true },
    ],
    status: 'active',
  },
  {
    ...
    actions: [
      { icon: '📗', label: 'See Schedule' },
      { icon: '💬', label: 'Join Roundtable', highlight: true },
    ],
    status: 'active',
  },
]
